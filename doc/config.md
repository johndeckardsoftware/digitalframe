...
| items.types.image.matte.type | `0` | type |
...
| window.hdmi_off_timeout | `0` | hdmi_off_timeout |
| window.hdmi_power | `0` | hdmi_power |
...
| window.light_average.12 | `200` | 12 |
...
| window.log_level | `20` | log_level |
| window.lux_adjustment | `40` | lux_adjustment |
| window.max_height | `2160` | max_height |
| window.max_width | `3840` | max_width |
...
| window.run_mode | `desktop` | run_mode |
